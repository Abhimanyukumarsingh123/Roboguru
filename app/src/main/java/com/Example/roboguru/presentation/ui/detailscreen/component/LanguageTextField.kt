...
fun LanguageTextField() {
    var ChooseLanguage by remember { mutableStateOf("") }
    var expanded by remember { mutableStateOf(false) }
    val classOptions = listOf("English", "Hindi", "Urdu",)
    ...
    Column(
        ...
        Row(
            ...
            BasicTextField(
                ...
                onValueChange = { ChooseLanguage = it },
                singleLine = true,
                modifier = Modifier
                    .weight(1f)
        ...
        DropdownMenu(
            ...
            classOptions.forEach { gender ->
                DropdownMenuItem(
                    ...
                    onClick = {
                        ChooseLanguage = gender // Set selected gender
