...
@Composable
fun ClassTextField() {
    var ChooseClass by remember { mutableStateOf("") }
    var expanded by remember { mutableStateOf(false) }
    val classOptions = listOf("Class VI", "Class VII", "Class VIII", "Class IX", "Class X")
        ...
        DropdownMenu(
            ...
            classOptions.forEach { gender ->
                DropdownMenuItem(
                    ...
                    onClick = {
                        ChooseClass = gender // Set selected gender
